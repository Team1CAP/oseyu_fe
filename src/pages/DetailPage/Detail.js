    ...
    <>
      <div className="px-7 text-left">
        ...
        <div className="flex flex-row justify-end">
          <button className="px-3 py-1 mr-3 rounded-lg font-bold bg-main-yellow">
            지원하기
          </button>
        ...
        <ul>
          <li className={detailData}>위치 : 충청남도 논산시 노성면 병사리</li>
          <li className={detailData}>기간 : 9월 17(금)부터 9월 19(일) 3일간</li>
          ...
          <li className={detailData}>
            상세설명 : 무주 사과열매 솎기 체험은 다음과 같이 일정 방법은 다음과
            같다. 1차 적과는 중심과를 남기고 측과를 제거하고, 과실과 과실 사이의
            거리가 대체로 한 뼘(약20cm)정도 되도록 거리적과 실시 2차 적과는 나무
            전체 엽수에 대한 착과수를 산출하여 적과 3차 적과는 상품과 및
            수량성을 전제로 엽과비를 기준으로 정밀한 적과작업 실시
          </li>
        </ul>
      </div>
    </>
